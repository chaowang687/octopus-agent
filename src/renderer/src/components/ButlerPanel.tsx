        ...
        <TabsContent value="projects" className="space-y-4">
          <div className="grid gap-4">
            {projects.map((project) => (
              <Card key={project.id} className={`cursor-pointer transition-all ${activeProject?.id === project.id ? 'ring-2 ring-primary' : ''}`} onClick={() => handleSelectProject(project)}>
                <CardHeader>
                  <div className="flex items-center justify-between">
        ...
        <TabsContent value="problems" className="space-y-4">
          <div className="grid gap-4">
            {problems.map((problem) => (
              <Card key={problem.id} className={`cursor-pointer transition-all ${selectedProblem?.id === problem.id ? 'ring-2 ring-primary' : ''}`} onClick={() => handleSelectProblem(problem)}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
