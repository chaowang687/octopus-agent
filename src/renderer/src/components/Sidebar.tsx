    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav-container">
        <ul className="sidebar-nav">
          ...
          <li>
            <NavLink to="/documents" className="sidebar-nav-link" title="文档管理">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li>
            <NavLink to="/code-editor" className="sidebar-nav-link" title="代码编辑器">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li>
            <NavLink to="/cloud-storage" className="sidebar-nav-link" title="云存储管理">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li>
            <NavLink to="/backup" className="sidebar-nav-link" title="数据备份">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
